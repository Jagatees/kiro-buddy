...
describe('renderer status payload animation mapping', () => {
  const cases: Array<[Partial<StatusPayload>, AnimationKey, string, boolean]> = [
    ...
    [{ status: 'done' }, 'idle', 'Kiro Done', true],
    ...
    [{ status: 'done', phase: 'design' }, 'idle', 'Design Done', true],
    [{ status: 'done', phase: 'requirements' }, 'idle', 'Requirements Done', true],
    [{ status: 'done', phase: 'tasks' }, 'idle', 'Task List Done', true],
